...
- **The composite sign audit headline per interval**: 5m composite ic -0.0151, ceiling 0.015802, cheapest taker be 0.1103 (ceiling far below); 15m composite ic -0.0344, ceiling 0.018879, cheapest taker be 0.0324 (ceiling below); 1h composite ic -0.0086, ceiling 0.009404, cheapest taker be 0.0145 (ceiling below); 4h composite ic +0.0374, ceiling 0.024960, cheapest taker be 0.0061 (ceiling above, unprovable at this sample size); 1d composite ic +0.0110 (insignificant, t 0.53), ceiling 0.048550, cheapest taker be 0.0035 (ceiling above, htf category missing). The 5m and 1d columns are the `p3b-lag1` reports of 2026-09-20 under the pre-configVersion-6 scorer; 15m, 1h and 4h are the `pB-ts` reports of 2026-09-26 under the v7 scorer, so sig-level signs are not directly comparable across that boundary
